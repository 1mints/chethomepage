...
import UpIcon from '@/app/assets/up-arrow.svg';
...
export default function TextInput() {
    ...
    return (
        <div className="fixed bottom-0 max-w-3xl w-inherit flex flex-col bg-chetgpt-dark-bg">
            <div className={`${isActive ? 'focus:border-neutral-300' : 'border-neutral-700'} "bottom-0 max-w-3xl w-full flex flex-row mx-auto justify-center items-center rounded-md shadow-sm border border-solid focus:border-neutral-300`}>
                <textarea
                    className="bg-transparent text-white p-0 pl-10 pr-10 pt-2 pb-2 resize-none focus:outline-none focus:ring-0 w-full h-11 placeholder-neutral-600 max-h-20 overflow-hidden"
                    ref={textAreaRef}
                    value={text}
