"use client";
import Messages from "@/app/components/chat/messages.component";
import TextInput from "@/app/components/chat/text-input.component";
import Image from "next/image";
import {messagesAtom} from "@/app/components/chat/atom";
                        ...
                        {links.map((link, index) => (
                            <div onClick={() => {
                                handlePromptLink(link.prompt)
                                 ...
                                 className={`${index > 1 ? 'hidden' : ''} w-full md:block md:w-45pr px-5 py-2 border border-solid border-neutral-700 mx-2 my-1 rounded-lg transition ease-in-out delay-50 hover:border-[#0FFF00]`}>
